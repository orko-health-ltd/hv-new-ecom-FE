<template>
  <div>
     <div class="overflow-hidden">
      ...
      <div class="h-[70vh] w-full bg-[url('/assets/images/Cover-scaled.jpg')] bg-cover bg-fixed top-0  overflow-x-hidden animate-breathout">
        <div class="flex flex-col justify-center items-center h-full w-full bg-black bg-opacity-50">
          <h1 class="text-white text-center text-4xl md:text-6xl font-bold">
    ...
    <div class="flex flex-wrap -mx-4">
      ...
      <div class="w-full md:w-1/2 px-4 mb-8">
        ...
        <div class="flex gap-4 py-4 justify-center overflow-x-auto">
          <img v-for="image in product.images" :key="image" :src="image" alt="Thumbnail 1"
  ...
  reviews: [
    {
      name: 'John Doe',
      rating: 5,
      comment: 'This tea is amazing! I love the taste and the aroma. It is definitely my new favorite tea.',
      date: '2022-01-01'
    },
    {
      name: 'Jane Doe',
      rating: 4,
      comment: 'This tea is good, but not as good as I expected. It is still a good tea, but not as good as I expected.',
      date: '2022-01-02'
 } ]
}
