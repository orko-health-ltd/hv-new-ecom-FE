<template>
   ...
   <div class="flex flex-col sm:flex-row justify-between items-center w-full container px-5 py-7">
    <div class="flex flex-col md:py-10 md:px-12 items-center space-x-5 mb-2 text-white">
  ...
  <div class="flex flex-col md:flex-row justify-end items-center w-full px-4 gap-5 py-7">
    <h1 class="text-xl md:text-3xl font-extralight text-white">Newsletter</h1>
      <div class="relative">
        ...
        <UIcon name="mdi:email" class="text-yellow-600 text-sm md:text-xl absolute left-3 top-1/2 transform -translate-y-1/2" />
      </div>    </div>
  </div>
  </div>
