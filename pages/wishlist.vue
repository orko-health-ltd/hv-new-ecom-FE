<template>
  <div>
   ...
   \  
      <nuxt-link :to="`/wishlist/${route?.params.slug}`">
      wishlist</nuxt-link
      >-->
        <div class="h-[300px] sm:h-[400px] md:h-[500px] w-full bg-[url('/assets/images/wishlist.jpg')] start bg-cover top-0 flex justify-center items-center overflow-x-hidden ">
          <h1 class="text-white font-bold text-5xl">My Wishlist</h1>
    </div> 
...
const products = ref(cartStore.wishlist)
