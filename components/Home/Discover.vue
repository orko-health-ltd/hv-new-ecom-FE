<template>
  <div class="bg-[url('/assets/images/home/bg-discover.jpg')] h-[40vh] flex justify-center items-center  bg-fixed bg-cover">
    <div class="flex flex-col justify-center items-center">
       <div class="flex items-center space-x-5 mb-2 text-white">
